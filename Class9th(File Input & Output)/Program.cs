namespace Class9th_File_Input___Output_
{
    internal class Program
    {
        static void LoadText(string name)
        {
        ...
        {
            // File : 파일에 대한 생성과 복사, 이동 및 열기를 위한 클래스
            ...
            // StreamReader streamReader = new StreamReader("Marine.txt");
            // 
            // while (streamReader.Peek() >= 0)
            // {
            //     Console.WriteLine(streamReader.ReadLine());
